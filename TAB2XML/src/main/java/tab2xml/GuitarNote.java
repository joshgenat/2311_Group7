...
public class GuitarNote {
	...
	static void note(Document doc, Element measureNumber, GuitarNotes g) {
	...
	static void pitch(Document doc, Element note, GuitarNotes g) {
	...
	static void notations(Document doc, Element note, GuitarNotes g) {
		...
		static void technical(Document doc, Element notations, GuitarNotes g) {
			...
			static void string(Document doc, Element technical, GuitarNotes g) {
				Element string = doc.createElement("string");        
				string.appendChild(doc.createTextNode("" + g.string) ); 
				technical.appendChild(string);
			}
	
			static void fret(Document doc, Element technical, GuitarNotes g) {
